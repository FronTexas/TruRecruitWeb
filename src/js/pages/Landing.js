			...
			<div>
				...
				<div class="container-fluid instruction">
					<div class="container">
						...
						<div class="row">
							<div class="col m4 instruction-card-container">
				...
				<div class="container-fluid ">
					<div class="row">
						<div class="col-sm-2"><p><b>TruRecruit 2017</b></p></div>
						<div class="col-sm-1"><p><a href="./contact.html"><b>Contact Us</b></a></p></div>
					</div>
				</div>
			</div>
		)
